...
class Registration_details(models.Model):
    ...
    invited_users = models.ManyToManyField(User, related_name='invited_forms', blank=True)
    accepted_users = models.ManyToManyField(User, related_name='accepted_forms', blank=True)
    rejected_users = models.ManyToManyField(User, related_name='rejected_forms', blank=True)
    
    invited_club = models.ManyToManyField(ClubDetails, blank=True, related_name='forms')
...
class Notification(models.Model):
    ...
    user = models.ForeignKey(User, related_name = 'form_notifications', on_delete=models.CASCADE )
    title = models.CharField(max_length=255)
