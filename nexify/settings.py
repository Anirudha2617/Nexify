...
SECRET_KEY = 'django-insecure-*5&h-fex85oa9#ilo&v*0_ddr0epbg^^%+&i3p*3g1y8w0-)p@'
...
MIDDLEWARE = [
    ...
    "allauth.account.middleware.AccountMiddleware", #all auth middlewares
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'club.context_processors.club_data_pk',
            ],
        },
    },
]
