...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('event', '0004_alter_registration_details_registration_start'),
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.DateTimeField(default=datetime.datetime(2024, 12, 21, 21, 0, 9, 624673)),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teams', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='event.event')),
            ],
        ),
    ]
