...
urlpatterns = [
    ...
    path('edit/<int:form_id>/extrapage', views.edit_extradetails, name='edit_extradetails'),
    ...
    path('delete_extradetails_form/<int:form_id>/', views.delete_extradetails_form, name='delete_extradetails_form'),
